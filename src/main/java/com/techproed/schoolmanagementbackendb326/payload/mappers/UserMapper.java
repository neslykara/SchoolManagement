...
public class UserMapper {
  ...
  public User  mapUserRequestToUser(BaseUserRequest userRequest, String userRole) {
    ...
    if(userRole.equalsIgnoreCase(RoleType.ADMIN.getName())){
      ...
      // ❗ Eğer userRequest bir StudentRequest ise annesi ve babası da set edilir
      if (userRequest instanceof StudentRequest) {
        StudentRequest studentRequest = (StudentRequest) userRequest;
